...
namespace PruebaMySQL
{
    public partial class Venta : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionMySql.ejecutaConsultaSelect("SELECT *FROM Venta ORDER BY idVenta");
        }
        ...
        private void btnBorrar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE Venta SET Estatus = False WHERE idVenta = " + idVenta.ToString(); ;
            ConexionMySql.ejecutaConsulta(consulta);
            MostrarDatos();
        }
    }
