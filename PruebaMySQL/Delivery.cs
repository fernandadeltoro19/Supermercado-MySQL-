...
namespace PruebaMySQL
{
    public partial class Delivery : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionMySql.ejecutaConsultaSelect("SELECT *FROM Delivery ORDER BY idDelivery");
        ...
        private void btnBorrar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE Delivery SET Estatus = False WHERE idDelivery = " + idDelivery.ToString(); ;
            ConexionMySql.ejecutaConsulta(consulta);
            MostrarDatos();
