...
namespace PruebaMySQL
{
    public partial class Empresa : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionMySql.ejecutaConsultaSelect("SELECT *FROM Empresa ORDER BY idEmpresa");
        ...
        private void btnBorrar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE Empresa SET Estatus = False WHERE idEmpresa = " + idEmpresa.ToString(); ;
            ConexionMySql.ejecutaConsulta(consulta);
            MostrarDatos();
        }
    }
